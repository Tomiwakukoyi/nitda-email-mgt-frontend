...
const stats = [
  { label: 'Total Emails', value: 6, icon: <MailOutline fontSize="small" />, sub: '+14% from last hour' },
...
const StatsGrid = () => (
  <Grid container spacing={2} mb={2} sx={{ width: '100%' }}> {/* Added spacing between cards */}
